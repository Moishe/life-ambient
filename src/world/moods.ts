...
export const MOODS: readonly Mood[] = [
  {
    id: 'reading',
    name: 'Reading',
    tagline: 'near-silence, sparse drones',
    rateRange: [1, 2],
  ...
  },
  {
    id: 'writing',
    name: 'Writing',
    tagline: 'a steady patient pulse',
    rateRange: [3, 4],
  ...
  },
  {
    id: 'thinking',
    name: 'Thinking',
    tagline: 'slow drifting movement',
    rateRange: [4, 5],
  ...
  },
  {
    id: 'break',
    name: 'Break',
    tagline: 'light chimes, easy listening',
    rateRange: [2, 3],
  ...
  },
  {
    id: 'grinding',
    name: 'Grinding',
    tagline: 'continuous driving stream',
    rateRange: [4, 4],
    scales: ['dorian'],
    arpMode: false,
    groups: [
